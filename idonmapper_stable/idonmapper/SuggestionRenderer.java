 ...
 * currently highlighted (focused) list cell in a JComboBox.
 */ 
public class SuggestionRenderer extends JLabel implements ListCellRenderer 
{
    ...
    private int focusedCellIndex = NONE;   
    private int selectedCellIndex = NONE;   
    private JList currentList = null;
     ...
     */ 
    public SuggestionRenderer(final JComboBox combo)
    {
        this();
    ...
    /**
     * Generic constructor for use with other componenents.
     */ 
    ...
    /**
     * Used to find the currently focused (highlighted) cell in the
     * Jcombo.
     * 
     * @return The index in the List to the focused Object.
     */ 
