...
{ 
    ...
    private TreeSet<String> visibleSuggestions = new TreeSet<String>();
    ...
    public void	keyPressed(KeyEvent e)
    {
        ...
        else if(Controller.isShiftKey(e))
        {
            Controller.setShiftDown(true);
            return;
        }
        else if(Controller.isControlKey(e))
        {
            Controller.setControlDown(true);
            return;
        }
    } 
